...
("The Witcher 3", "PS4 | PC","RPG | Open World", True, 2015, 2018, 300, 100, False),
("The Witcher 2", "PC","RPG | Open World", False, 2011, 2018, 15, 85,False),
("The Witcher", "PC","RPG | Open World", False, 2008, 2018, 15, 85,False),

("Grand Theft Auto I", "PC", "Open World | Action-Adventure", True, 1997, 1998,20,88, True),
...
("Kingdom Hearts 3", "PS4", "Action | JRPG", True, 2019,2019, 40,95,True),
("Kingdom Hearts : Birth by Sleep", "PSP", "Action | JRPG", True, 2010,2017, 35,92, False),

("The Legend of Zelda : Wind Waker", "GameCube","Action-Adventure", False, 2002, 2008, 35,91,False),
...
("The Legend of Zelda : Breath to the Wild", "Switch", "Action-Adventure | Open World", False, 2016,2020,1,90, True),
...
#Assassin's Creed
("Assassin's Creed 2", "PS3", "Action-Adventure | Open World", True, 2012,2015, 35,93,True),
("Assassin's Creed 3", "PS3", "Action-Adventure | Open World", True, 2014,2015, 35,93,True),
("Assassin's Creed 4 Black Flag", "PS3", "Action-Adventure", True, 2013,2016, 35,94,True),
("Assassin's Creed 5 Unity", "PC", "Action-Adventure | Open World", False, 2014,2018, 40,93,True),
("Assassin's Creed Origins", "PS4", "Open World | RPG", True, 2017,2017, 50,96,True),
("Assassin's Creed Odyssey", "PC", "Open World | RPG", False, 2018,2018, 80,97,True),
...
("Worms", "PC", "STR | Shooter", False, 1995,1996, 30,80,True),
("Worms 2", "PC", "STR | Shooter", False, 1997,1997, 30,82,True),
("Worms Armageddon", "PC", "STR | Shooter", False, 1999,2000, 40,87,True),
("Worms W.M.D", "PS4", "STR | Shooter", False, 2016,2018, 20,87,True),
...
("Baldur's Gate II" , "PC", "Action-Adventure | RPG", True, 2000, 2001, 50, 92, False),
...
("Oddworld", "PC", "Action-Adventure | Platformer", True, 1997,1999, 25,85,True),
("Oddworld 2", "PC", "Action-Adventure | Platformer", True, 1998,2000, 10,86,True),("Lemmings", "PC","RTS", False, 1991, 1993, 15, 72,True),
...
("Star Wars Battlefront 2", "PS4", "FPS", True, 2017,2017, 30,87,True),
...
("Star Wars The Force Unleashed 2", "PS3", "Hack&Clash", True, 2008,2016, 15,75,False),
...
("Tekken", "PS1", "Fighting", False, 1995, 1997,20,79, True),
("Resident Evil 2", "PS1", "Shooter", False, 1998, 1998,10,80, True),
...
("Street Fighter 2", "Megadrive","Fighting", False, 1991, 1995, 20, 67,True),
("Dragon Ball Z", "Megadrive","Fighting", False, 1994, 1996, 10, 68,True),
("Mortal Kombat", "Megadrive","Fighting", False, 1992, 1994, 10, 67,True),
...
("Mario Kart Wii", "GameCube","Racing", False, 2008, 2008, 30,90,True),
...
("Wii Sport", "Wii", "Sport", False, 2006,2006,5,80, True),
("Pokémon Pinball", "GBA", "Puzzle", False, 1999,2000,10,78, True),

#Android
("Monument Valley", "Android", "Puzzle", True, 1999,2000,2,78, True),
("Monument Valley 2", "Android", "Puzzle", True, 1999,2000,2,78, True),
("Polytopia", "Android", "STR", True, 1999,2000,2,78, True)
;