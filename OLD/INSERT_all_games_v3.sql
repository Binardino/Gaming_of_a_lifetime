...
("God of War IV", "PS4", "Action|Beat'em All", False, 2018, 2020,60,99,False),
...
("Oddworld: Abe's Exoddus", "PC", "Action-Adventure|Platformer", True, 1998,2000, 10,86,True),("Lemmings", "PC","STR", False, 1991, 1993, 15, 72,True),
...
("Star Wars: Battlefront", "PC", "FPS|Space Shooter", True, 2015,2015, 20,80,True),
("Star Wars: Battlefront II", "PS4", "FPS|Space Shooter", True, 2017,2017, 30,87,True),
