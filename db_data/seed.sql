...
INSERT INTO public.gaming_lifetime (game_name,console,game_type,finished,published_year,played_year,hours_played,perso_score,multiplayed, country_dev, studio, editor) VALUES
	 ...
	 ('Stronghold','PC','STR', false,2003,2003,10,73,true, 'UK', 'Firefly Studios', 'Firefly Studios'),
	 ('Nox','PC','RPG|Hack&Clash',true,2008,2018,10,75,true, 'USA', 'Westwood Studios', 'Electronic Arts'),
...
INSERT INTO public.gaming_lifetime (game_name,console,game_type,finished,published_year,played_year,hours_played,perso_score,multiplayed, country_dev, studio, editor) VALUES
	 ...
	 ('Disney''s The Lion King','Megadrive','Action-Adventure|Platformer',false,1994,1994,15,80,true, 'USA','Westwood Studios','Virgin Interactive'),
	 ('Dr Robotnik','Megadrive','STR',true,1993,1993,30,89,true, 'USA','BlueSky Software','Sega'),
	 ('Micromachines','Megadrive','Racing',false,1994,1994,15,80,true, 'UK','Codemasters','Codemasters'),
	 ('Tintin in Tibet','Megadrive','Platformer',false,1995,1996,10,71,true, 'France','Infogrames','Infogrames'),
...
INSERT INTO public.gaming_lifetime (game_name,console,game_type,finished,published_year,played_year,hours_played,perso_score,multiplayed, country_dev, studio, editor) VALUES
	 ...
	 ('Street Fighter 2','Megadrive','Versus Fighting',false,1991,1995,20,67,true, 'Japan','Capcom','Capcom'),
	 ('Dragon Ball Z','Megadrive','Versus Fighting',false,1994,1996,10,68,true, 'Japan','Bandai','Bandai'),
	 ('Mortal Kombat','Megadrive','Versus Fighting',false,1992,1994,10,67,true, 'USA','Midway Games','Acclaim'),
...
INSERT INTO public.gaming_lifetime (game_name,console,game_type,finished,published_year,played_year,hours_played,perso_score,multiplayed, country_dev, studio, editor) VALUES
	 ...
	 ('Mario Galaxy','Switch','Platformer',false,2008,2020,20,94,true, 'Japan', 'Nintendo', 'Nintendo'),
	 ('Super Mario Sunshine','Switch','Platformer',false,2003,2020,10,75,true, 'Japan', 'Nintendo', 'Nintendo'),
	 ('Final Fantasy XII','Switch','JRPG',true,2006,2021,40,93,false, 'Japan', 'Square Enix','Square Enix'),
	 ('Hades','Switch','Action-Adventure|Hack&Clash',false,2020,2021,30,93,false, 'USA', 'Supergiant Games', 'Supergiant Games'),
...
INSERT INTO public.gaming_lifetime (game_name,console,game_type,finished,published_year,played_year,hours_played,perso_score,multiplayed, country_dev, studio, editor) VALUES
	 ...
	 ('Horizon Forbidden West','PS5','RPG|Open World',true,2022,2022,50,93,false, 'Netherlands', 'Guerrilla Games' , 'Sony'),
	 ('Hogwart''s Legacy','PS5','Open World|RPG',false,2023,2023,50,95,false,'USA', 'Avalanche Software', 'Warner Bros. Games'),
 	 ('Star Wars Jedi Fallen Order','PC','RPG|Action-Adventure',true,2019,2020,25,89,false, 'USA','Respawn Entertainment','Electronic Arts'),
 	 ('Marvel''s Guardians of the Galaxy','PS5','RPG|Action-Adventure',false,2021,2023,15,89,false, 'Canada','Eidos-Montréal','Square Enix'),
 	 ('Kena: Bridge of Spirits','PS5','Action-Adventure',false,2021,2023,15,89,false, 'USA','Ember Lab','Ember Lab'),
	 ('Elden Ring','PS5','RPG|Open World',false,2022,2024,120,99,true, 'Japan','FromSoftware','Bandai Namco Entertainment'),
	 ('Star Wars Outlaws','PS5','RPG|Open World',false,2024,2024,50,93,false, 'Sweden','Ubisoft Massive','Ubisoft'),
	 ('Astro Bot','PS5','Platformer',false,2024,2024,3,88,false, 'Japan','Team Asobi','Sony Interactive Entertainment'),
	 ('Star Wars Jedi Survivor','PS5','RPG|Action-Adventure',false,2023,2025,25,89,false, 'USA','Respawn Entertainment','Electronic Arts'),
	 ('Baldur''s Gate','PS5','RPG|Action-Adventure',true,2023,2024,25,99,false, 'Belgium','Larian Studios','Larian Studios'),
	 ('Outer Wilds','PS5','Open World|Action-Adventure',false,2019,2024,90,99,true, 'USA','Mobius Digital','Annapurna Interactive'),
	 ('Clair Obscur Expedition 33','PS5','RPG',false,2025,2025,90,99,true, 'France','Sandfall Interactive','Kepler Interactive'),
	 ('Pokemon Y','3DS','Action-Adventure|JRPG',false,2013,2025,1,85,false, 'Japan','Game Freak','Nintendo'),
